...
public class SuccessPharmacyPersonnel extends Personnel implements IPersonnel, Serializable {
    ...
    public SuccessPharmacyPersonnel(int personnelID, String personnelName, String personnelSurname, String personnelGender, int personnelBirthYear, float personnelSalary, int personnelNumber, boolean militaryStatus, int graduationAverage, boolean criminalRecord) {
    ...
    //This method from Personnel interface. It checks military status.In short, people who have not done their military duty cannot work.
    @Override
    ...
    //This method from IPersonnel interface.This method checks the graduation average. Those with a graduation average of 50 to 100 can work in this pharmacy. Others cannot work.
    @Override
    public boolean graduationAverage(int graduationAverage) {
        if (graduationAverage<=50 && graduationAverage>=100)
        {
            return false;
        }
        else
