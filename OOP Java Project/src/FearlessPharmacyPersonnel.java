...
public class FearlessPharmacyPersonnel extends Personnel implements IPersonnel, Serializable {
    ...
    public FearlessPharmacyPersonnel(int personnelID, String personnelName, String personnelSurname, String personnelGender, int personnelBirthYear, float personnelSalary, int personnelNumber, boolean militaryStatus, int graduationAverage, boolean criminalRecord) {
        ...
        if(graduationAverage(graduationAverage) == false)
        {
    ...
    //This method from Personnel interface. It checks military status.In short, people who have not done their military duty can work.
    //Having not completed her military service is not an obstacle for her to work in this pharmacy.
    @Override
    ...
    //This method from IPersonnel interface.This method checks the graduation average. Those with a graduation average of 40 to 100 can work in this pharmacy. Others cannot work.

    @Override
    public boolean graduationAverage(int graduationAverage) {
        if (graduationAverage<=40 && graduationAverage>=100)
        {
            return false;
        }
        else
    ...
    //This method from IPersonnel interface.This method checks if the staff has a criminal record.Persons with a criminal record can work in this pharmacy.
    //Having a criminal record is not an obstacle to working this pharmacy.
    @Override
